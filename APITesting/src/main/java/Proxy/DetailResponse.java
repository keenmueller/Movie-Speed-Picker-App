...
public class DetailResponse {
    ...
    public List<ProductionCompanyModel> getProduction_companies() {
        return production_companies;
    }

    public void setProduction_companies(List<ProductionCompanyModel> production_companies) {
        this.production_companies = production_companies;
    }

    public List<ProductionCountryModel> getProduction_countries() {
        return production_countries;
    }

    public void setProduction_countries(List<ProductionCountryModel> production_countries) {
    ...
    public List<SpokenLanguageModel> getSpoken_languages() {
        return spoken_languages;
    }

    public void setSpoken_languages(List<SpokenLanguageModel> spoken_languages) {
